...
\IEEEauthorblockA{\IEEEauthorrefmark{2}Laboratoire d'Electroique et Electromagn\'{e}tisme L2E, Sorbonne Universit\'{e}, F-75005 Paris, france}
\IEEEauthorblockA{\small{\{sigolste,trung-hien,fhorlin,philippe.dedoncker\}@ulb.ac.be}}
...
\begin{figure}[t]
    \centering
    \centerline{\includegraphics[width = .5\textwidth]{img/secrecy_ebno_alpha_bor_globecom.pdf}}
