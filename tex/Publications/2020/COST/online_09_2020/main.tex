...
\author{\IEEEauthorblockN{Sidney J. Golstein\IEEEauthorrefmark{1}\IEEEauthorrefmark{2},
		Trung-Hien Nguyen\IEEEauthorrefmark{2},
		Fran\c cois Rottenberg\IEEEauthorrefmark{2},
		Fran\c cois Horlin\IEEEauthorrefmark{2}, \\
		Philippe De Doncker\IEEEauthorrefmark{2}, and
		Julien Sarrazin\IEEEauthorrefmark{1}} \\
		\IEEEauthorblockA{\IEEEauthorrefmark{1}Sorbonne Université, CNRS, Laboratoire de Génie Electrique et Electronique de Paris, 75252, Paris, France \\
		...
		\IEEEauthorblockA{\IEEEauthorrefmark{2}Wireless Communication Group,
...
%%%%%%% ABSTRACT %%%%%%%%%
\begin{abstract}
%Physical layer security (PLS) is a novel approach investigated to secure wireless communications from eavesdroppers. Time-reversal (TR) has recently been identified as a promising transmission scheme to implement PLS. This paper studies the PLS of a wireless frequency-domain (FD) TR wideband single-input single-output (SISO) orthogonal frequency-division multiplexing (OFDM) communication system in the presence of a passive eavesdropper. 
...
\begin{figure}[t]
    \centering
    \centerline{\includegraphics[width = .5\textwidth]{img/secrecy_ebno_alpha_bor_globecom.eps}}
...
%\begin{figure}[t]
%    \centering
%    \centerline{\includegraphics[width = .35\textwidth]{img/secrecy_bor_ebno_alpha.eps}}
