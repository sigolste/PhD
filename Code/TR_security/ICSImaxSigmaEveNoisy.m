function sigma_max = ICSImaxSigmaEveNoisy(U,snr_b,snr_e,alpha,type)
...
% terms of securty. 
% See ICSImaxSigmaNoiseless.m in order to find the condition on sigma that
% can be made at Alice to ensure a targetted SR when Eve is AWGN free, i.e.
% worst case scenario. 
% 
%
% INPUTS:
...
%   
%
% © Ir. Sidney Golstein, 25 Mar. 2021.
