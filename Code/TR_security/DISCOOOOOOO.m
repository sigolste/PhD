...
% 1. SR as a function of AN 
figure;
plot(100*(1-alpha),sr1_avg,'Marker','o'); hold on;
plot(100*(1-alpha),sr1_ICSI_model,'Marker','<'); hold on; 
plot(100*(1-alpha),sr2_avg,'Marker','square','color','m'); hold on;
plot(100*(1-alpha),sr2_ICSI_model,'Marker','square','color','g'); hold on;
plot(100*(1-alpha),sr5_avg,'Marker','diamond','color','c'); hold on;
plot(100*(1-alpha),sr5_ICSI_model,'Marker','diamond','color','y'); hold on;
box on; grid on;
