...
plot(100*alpha,sr5_avg,'Marker','v','color','k'); hold on;

box on; grid on;
xlabel('Percentage of energy radiated dedicated for data (\%)')
ylabel('Secrecy rate (bit/channel use)')
legend('Same decoder - Simulation' , 'Matched filtering - Simulation' , 'AN killer - Simulation','LMMSE - Simulation', '$H_E$ knowledge')
...
plot(100*alpha,sr5_avg,'Marker','diamond','color','k'); hold on;
plot(100*alpha,sr5_model,'Marker','diamond','color','y'); hold on;
box on; grid on;
xlabel('Percentage of energy radiated dedicated for data (\%)')
ylabel('Secrecy rate (bit/channel use)')
% legend('Same decoder - Simulation' , 'Same decoder - Modeling' , 'Matched filtering - Simulation' , 'Matched filtering - Modeling')
