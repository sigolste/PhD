...
%   which decoding structure the SR decreases/increases. 
%
%
...
plot(100*(1-alpha),squeeze(sr1_avg(:,1,2)),'Marker','square'); hold on;
plot(100*(1-alpha),squeeze(sr1_avg(:,2,1)),'Marker','v'); hold on;
plot(100*(1-alpha),squeeze(sr1_avg(:,2,2)),'Marker','<'); 
legend('Correl @B and @E','Correl @B, uncorrel @E','Uncorrel @B, correl @E', 'Uncorrel @B and @E','Location','bestoutside')
box on; grid on;
xlabel('Percentage of AN energy ($\%$)');
ylabel('Ergodic Secrecy Rate (bit/channel use)')
title('SDS Decoder')


figure;
plot(100*(1-alpha),squeeze(sr2_avg(:,1,1)),'Marker','o'); hold on;
plot(100*(1-alpha),squeeze(sr2_avg(:,1,2)),'Marker','square'); hold on;
plot(100*(1-alpha),squeeze(sr2_avg(:,2,1)),'Marker','v'); hold on;
plot(100*(1-alpha),squeeze(sr2_avg(:,2,2)),'Marker','<'); 
legend('Correl @B and @E','Correl @B, uncorrel @E','Uncorrel @B, correl @E', 'Uncorrel @B and @E','Location','bestoutside')
box on; grid on;
xlabel('Percentage of AN energy ($\%$)');
ylabel('Ergodic Secrecy Rate (bit/channel use)')
...
figure;
plot(100*(1-alpha),squeeze(sr3_avg(:,1,1)),'Marker','o'); hold on;
plot(100*(1-alpha),squeeze(sr3_avg(:,1,2)),'Marker','square'); hold on;
plot(100*(1-alpha),squeeze(sr3_avg(:,2,1)),'Marker','v'); hold on;
plot(100*(1-alpha),squeeze(sr3_avg(:,2,2)),'Marker','<'); 
legend('Correl @B and @E','Correl @B, uncorrel @E','Uncorrel @B, correl @E', 'Uncorrel @B and @E','Location','bestoutside')
box on; grid on;
xlabel('Percentage of AN energy ($\%$)');
ylabel('Ergodic Secrecy Rate (bit/channel use)')
title('AN Killer Decoder')


figure;
plot(100*(1-alpha),squeeze(sr4_avg(:,1,1)),'Marker','o'); hold on;
plot(100*(1-alpha),squeeze(sr4_avg(:,1,2)),'Marker','square'); hold on;
plot(100*(1-alpha),squeeze(sr4_avg(:,2,1)),'Marker','v'); hold on;
plot(100*(1-alpha),squeeze(sr4_avg(:,2,2)),'Marker','<'); 
legend('Correl @B and @E','Correl @B, uncorrel @E','Uncorrel @B, correl @E', 'Uncorrel @B and @E','Location','bestoutside')
box on; grid on;
xlabel('Percentage of AN energy ($\%$)');
ylabel('Ergodic Secrecy Rate (bit/channel use)')
...
figure;
plot(100*(1-alpha),squeeze(sr5_avg(:,1,1)),'Marker','o'); hold on;
plot(100*(1-alpha),squeeze(sr5_avg(:,1,2)),'Marker','square'); hold on;
plot(100*(1-alpha),squeeze(sr5_avg(:,2,1)),'Marker','v'); hold on;
plot(100*(1-alpha),squeeze(sr5_avg(:,2,2)),'Marker','<'); 
legend('Correl @B and @E','Correl @B, uncorrel @E','Uncorrel @B, correl @E', 'Uncorrel @B and @E','Location','bestoutside')
box on; grid on;
xlabel('Percentage of AN energy ($\%$)');
ylabel('Ergodic Secrecy Rate (bit/channel use)')
